 ...
 * @author Vinicius
 */
public class ViewProducao extends javax.swing.JFrame {
    ...
    DAOProducao daoProducao = new DAOProducao();
    ...
    public ViewProducao(ModelProducao modelProducao, ViewConsulta viewConsulta, boolean todos, int codProducao) {
        initComponents();
        preencher_comboBoxProduto();
        preencher_comboBoxEtapas();
        preencher_comboBoxRecurso();
        ...
        this.todos = todos;
        this.codP = codProducao;

        BLDatas bl = new BLDatas();

        alterarSalvar = "alterar";

        fieldCodigo.setText(String.valueOf(modelProducao.getIdCodigo()));
        comboProduto.setSelectedItem(modelProducao.getDescProduto());
        comboEtapa.setSelectedItem(modelProducao.getDescEtapa());
        comboRecurso.setSelectedItem(modelProducao.getDescRecurso());
        try {
            dataInicio.setText(bl.converterDataUSParaDateString(modelProducao.getDataInicio()));
            dataTermino.setText(bl.converterDataUSParaDateString(modelProducao.getDataTermino()));
        } catch (Exception ex) {
            Logger.getLogger(ViewProducao.class.getName()).log(Level.SEVERE, null, ex);
        }
        horaInicio.setText(modelProducao.getHoraInicio().toString());
        horaTermino.setText(modelProducao.getHoraTermino().toString());
        fieldPeso.setText(String.valueOf(modelProducao.getPesoProducao()));
        comboOperador.setSelectedItem(modelProducao.getOperador());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Apontamento de Produção");
                    ...
                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(comboOperador, javax.swing.GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public void salvar() {
        ...
        modelProducao.setDescProduto(String.valueOf(comboProduto.getSelectedItem()));
        modelProducao.setDescEtapa(String.valueOf(comboEtapa.getSelectedItem()));
        modelProducao.setDescRecurso(String.valueOf(comboRecurso.getSelectedItem()));
        try {
            modelProducao.setDataInicio(bl.converterDataStringParaDate(dataInicio.getText()));
            modelProducao.setDataTermino(bl.converterDataStringParaDate(dataTermino.getText()));
            try {
                ...
                modelProducao.setHoraInicio(time1);
            ...
            try {
                ...
                modelProducao.setHoraTermino(time2);
            } catch (ParseException ex) {
                Logger.getLogger(ViewProducao.class.getName()).log(Level.SEVERE, null, ex);
            }
        } catch (Exception ex) {
        ...
        modelProducao.setPesoProducao(Double.parseDouble(con.converterVirgulaParaPonto(fieldPeso.getText())));
        modelProducao.setOperador(String.valueOf(comboOperador.getSelectedItem()));

        if (alterarSalvar.equals("salvar")) {
            if (controllerProducao.salvarCadastroProducao(modelProducao) > 0) {
                JOptionPane.showMessageDialog(this, "Produção cadastrada com sucesso!", "Notificação", JOptionPane.WARNING_MESSAGE);
                buscaCodigoMaximo();
                habilitarDesabilitarCampos(false);
                limpaTela();
            } else {
                JOptionPane.showMessageDialog(this, "Erro ao cadastrar a produção!", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            modelProducao.setIdCodigo(Integer.parseInt(fieldCodigo.getText()));
            if (controllerProducao.atualizarProducaoController(modelProducao)) {
                JOptionPane.showMessageDialog(this, "Produção alterada com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
                limpaTela();
                //habilitarDesabilitarCampos(false);
                ...
                if (this.todos == true) {
                    ...
                    viewConsulta.carregarProducao(!todos);
                }

            } else {
                JOptionPane.showMessageDialog(this, "Erro ao alterar a produção!", "Erro", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    public void textonulo() {
        ...
        ViewProducao telaProducao = this;
        new Thread() {
            @Override
            public void run() {
                try {
                    for (int i = 0; i < 4; i++) {
                        telaProducao.setLocation(p.x - 10, p.y - 2);
                        sleep(20);
                        telaProducao.setLocation(p.x + 10, p.y + 2);
                        sleep(20);
                    }
                    telaProducao.setLocation(p.x, p.y);
    ...
    public void validacao() {
        if (comboProduto.getSelectedIndex() == -1 || comboEtapa.getSelectedIndex() == -1 || comboRecurso.getSelectedIndex() == -1
                ...
                || horaTermino.getText().equals("") || fieldPeso.getText().equals("") || comboOperador.getSelectedIndex() == -1) {
            textonulo();
    ...
    public void buscaCodigoMaximo() {
        ...
        c.conectar();
        try {
            cod = daoProducao.buscaCodigoMaximo();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        // EXCLUI UMA PRODUÇÃO NO BANCO
        if (controllerProducao.excluirCadastroProducao(codP)) {
            JOptionPane.showMessageDialog(this, "Produção excluida com sucesso!", " ATENÇÃO", JOptionPane.WARNING_MESSAGE);;
            limpaTela();
            btnNovo.setEnabled(false);
            dispose();
            if (this.todos == true) {
            ...
            JOptionPane.showMessageDialog(this, "Erro ao excluir a produção!", "ERRO", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewProducao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewProducao().setVisible(true);
            }
        });
    }
